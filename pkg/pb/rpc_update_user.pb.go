...
func (x *UpdateUserResponse) GetUserAgent() string {
	if x != nil {
		return x.UserAgent
	}
	return ""
...
func (x *UpdateUserResponse) GetClientIp() string {
	if x != nil {
		return x.ClientIp
	}
	return ""
...
const file_rpc_update_user_proto_rawDesc = "" +
	...
	"\tclient_ip\x18\x03 \x01(\tR\bclientIpB*Z(github.com/Iowel/app-auth-service/pkg/pbb\x06proto3"
